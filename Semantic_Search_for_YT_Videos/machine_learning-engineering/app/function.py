...
import polars.lazyframe.frame
import sentence_transformers
import sklearn
import sklearn.metrics

# helper function
def returnSearchResultIndexes(query: str, df: polars.lazyframe.frame.LazyFrame, model, dist: sklearn.metrics._dist_metrics.MahalanobisDistance) -> np.ndarray:
    """
